...
[Report a problem or suggest a feature](https://github.com/HalcyonXP/playback-plus/issues)

Original Playback Plus code is [MIT licensed](LICENSE). Bundled RNNoise files retain their [third-party licenses and credits](content/vendor/rnnoise/PROVENANCE.md).
