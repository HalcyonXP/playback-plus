...
**Version 1.8.1 · Firefox 142+** · **[Download unsigned XPI](https://github.com/HalcyonXP/playback-plus/releases/download/v1.8.1/playback-plus-1.8.1.xpi)**

[![Playback Plus 1.8.1 Charcoal / Ice blue interface: playback speed with a saved new-tab default, Audio sync, Voice Clarity and keyboard shortcut configuration.](docs/images/playback-plus-overview.png)](docs/images/playback-plus-overview.png)

*Four views, one compact Charcoal / Ice blue panel. Shown with example settings; click the image for a closer look.*
...
1. [Download Playback Plus 1.8.1 (.xpi)](https://github.com/HalcyonXP/playback-plus/releases/download/v1.8.1/playback-plus-1.8.1.xpi) and save the file.
...
[Release notes and SHA-256 checksum](https://github.com/HalcyonXP/playback-plus/releases/tag/v1.8.1)

<details>
<summary>Try it temporarily in standard Firefox</summary>

1. Download **Source code (zip)** from the [release page](https://github.com/HalcyonXP/playback-plus/releases/tag/v1.8.1) and extract it.
...
Open the extension to change speed, or choose **Audio sync**, **Voice Clarity** or **Configuration**.
...
- Audio sync and Voice Clarity start **Off**. Changing a value does not turn either feature on.
